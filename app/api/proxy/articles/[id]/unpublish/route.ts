...
// POST /api/proxy/articles/[id]/unpublish - Dépublier un article (Admin/Manager/Modérateur)
export async function POST(
  ...
  try {
    ...
    const response = await fetch(`${apiConfig.baseUrl}/api/articles/${id}/unpublish`, {
      method: 'POST',
      headers: {
